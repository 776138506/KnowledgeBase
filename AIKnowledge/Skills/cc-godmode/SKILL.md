---
name: "cc-godmode"
description: "Self-Orchestrating Development Workflows - You say WHAT, the AI decides HOW. Invoke when you need automated development workflows including feature development, bug fixes, API changes, and research."
---
...
| @validator | Code Quality Gates | sonnet | Bash (tsc, tests) |
| @tester | UX Quality Gates | sonnet | Playwright, Lighthouse |
